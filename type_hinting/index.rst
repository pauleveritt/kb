...
- For x = chr('4x') I get a warning, is that from 484 with stubs?

- Where to put this repo?

- Generate a non-blog URL for these artifacts?

- Where to put the screencast? JetBrainsTV on YouTube or work a deal
  with someone like egghead.io?
